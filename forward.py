    ...
    for msg in messages:
        if msg.get("role") == "system":
            msg["content"] = (
                ...
                1. ACTUAL NEWLINE: If you see a line break in 'Read', use 4 backslashes ("\\\\n") in 'StrReplace' to match.
                2. Always DOUBLE the number of backslashes you see in the 'Read' output when writing the 'StrReplace' arguments. Using 8 backslashes with an 'n' in the JSON is interpreted as a backslash followed by 'n'. Meanwhile, 4 backslashes with an 'n' in the JSON represents a newline character.
                """
            )
            break
